...
Location: Chicago, IL
Phone: 773-970-6599
Email: saidhanushsoma@gmail.com
...
export default function Chatbot() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      //Breaking Change - const backendURL = process.env.REACT_APP_BACKEND_URL || "http://localhost:8000";
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "For More Details, You can contact Sai Dhanush at 773-970-6599 or saidhanushsoma@gmail.com.",
        },
      ]);
    }
  };
