...
# #Breaking Change 5 -  openai.api_key = os.getenv("OPENAI_API_KEY")
...
#         # "https://saidhanush.xyz",  # optional no-www version
#         # "https://sid-portfolio-rho.vercel.app"  # optional, for Vercel preview deploys,
...
# embedding_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../public/resume_embedding.json"))
